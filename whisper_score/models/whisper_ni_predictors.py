...
try:
    ...
    from whisper_score.models.whisper_wrapper import WhisperWrapper_full,WhisperWrapper_encoder, pad_or_trim, log_mel_spectrogram
    from whisper_score.models.transformer_wrapper import TransformerWrapper
    from whisper_score.models.transformer_config import CenterCrop,Config,Input    
